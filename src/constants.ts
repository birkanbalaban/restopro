import { Table, MenuItem, Staff, InventoryItem, SaleRecord } from './types';

export const TABLES: Table[] = [
  { id: '1', name: 'Masa 1', status: 'occupied', capacity: 4, currentOrderTotal: 450, occupiedTime: '45 dk', section: 'Ana Salon', x: 100, y: 100, type: 'square' },
  { id: '2', name: 'Masa 2', status: 'free', capacity: 2, section: 'Ana Salon', x: 250, y: 100, type: 'round' },
  { id: '3', name: 'Masa 3', status: 'bill-requested', capacity: 6, currentOrderTotal: 1250, occupiedTime: '1 sa 20 dk', section: 'Ana Salon', x: 400, y: 100, type: 'square' },
  { id: '4', name: 'Masa 4', status: 'occupied', capacity: 4, currentOrderTotal: 320, occupiedTime: '20 dk', section: 'Ana Salon', x: 100, y: 250, type: 'square' },
  { id: '5', name: 'Masa 5', status: 'dirty', capacity: 4, section: 'Ana Salon', x: 250, y: 250, type: 'square' },
  { id: '6', name: 'Teras 1', status: 'occupied', capacity: 4, currentOrderTotal: 580, occupiedTime: '35 dk', section: 'Teras', x: 100, y: 100, type: 'square' },
  { id: '7', name: 'Teras 2', status: 'free', capacity: 4, section: 'Teras', x: 250, y: 100, type: 'square' },
  { id: '8', name: 'Loca 1', status: 'occupied', capacity: 8, currentOrderTotal: 2100, occupiedTime: '2 sa', section: 'VIP', x: 100, y: 100, type: 'booth' },
];
...
export const INVENTORY: InventoryItem[] = [
  { id: 'i1', name: 'Dana Kıyma', category: 'Et', stock: 15.5, unit: 'kg', minStock: 5, price: 450 },
  { id: 'i2', name: 'Domates', category: 'Sebze', stock: 42, unit: 'kg', minStock: 10, price: 35 },
  { id: 'i3', name: 'Yoğurt', category: 'Süt Ürünleri', stock: 8, unit: 'kg', minStock: 5, price: 60 },
  { id: 'i4', name: 'Mercimek', category: 'Bakliyat', stock: 25, unit: 'kg', minStock: 5, price: 45 },
  { id: 'i5', name: 'Antep Fıstığı', category: 'Kuruyemiş', stock: 2, unit: 'kg', minStock: 3, price: 850 },
];

export const SALES: SaleRecord[] = [
  { id: 'sl1', tableId: '3', tableName: 'Masa 3', total: 1250, paymentMethod: 'card', timestamp: '18:45', itemsCount: 8 },
  { id: 'sl2', tableId: '12', tableName: 'Masa 12', total: 450, paymentMethod: 'cash', timestamp: '18:30', itemsCount: 4 },
  { id: 'sl3', tableId: '5', tableName: 'Masa 5', total: 820, paymentMethod: 'card', timestamp: '18:15', itemsCount: 6 },
];
